        ...
        <div id='hero'>
            <div className='h-screen place-content-center py-10 lg:py-16 px-lg-12'>
                ...
                <div className='text-white text-center space-y-7'>
                    <h1 className='text-4xl md:text-9xl uppercase text-[#7a50eb] hover:tracking-wider duration-200 ease-in-out'>S<span className='text-white text-xl md:text-8xl'>anthosh</span> <br className='hidden md:block'/> K<span className='text-white text-xl md:text-8xl'>umar</span></h1>
